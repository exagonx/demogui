...
type GFGUI
	...
	static TotalID as integer
	static FocusID as integer
	...
	dim as integer ItemID = 0
	dim as integer MaxCHILD_ID = 9
	redim as integer CHILD_ID(0 to 9)
	 
	'manage id that identify like child of a main item
	declare sub AS_CHILD(byval ITEMID as integer = 0)
...
type GFMAN
	...
	Public: 
	redim NameObject(0 To 99) as string
	redim IdObject(0 To 99) as integer
	dim IndexObject as integer
	
	Protected:
	declare sub CheckIndex()
